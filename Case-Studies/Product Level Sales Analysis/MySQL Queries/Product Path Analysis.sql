...
-- Step1: find the relevant /products pageviews with the website_session_id
-- Step2: find the next pageview id that occurs after the products pageview
...
/* Great analysis
   percent of /products pageviews that clicked to mr.fuzzy has gone down since the launch of love bear
   However, overall clickthrough rate has gone up, so it seems to be generating additional product interest
   overall */