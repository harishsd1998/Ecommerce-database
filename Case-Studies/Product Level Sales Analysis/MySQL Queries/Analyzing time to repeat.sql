  ...
  -- Step 2: Use the user_id from Step 1 to find any epeat sessions those users had
...
CREATE TEMPORARY TABLE sessions_w_repeats_for_time_dif
SELECT 
...
FROM sessions_w_repeats_for_time_dif
WHERE repeat_session_id IS NOT NULL
GROUP BY 1,2,3
) AS first_second;

SELECT * FROM users_first_to_seconds;
SELECT 
