...
CREATE TEMPORARY TABLE sessions_with_counts_landers_and_created_at
...
FROM sessions_with_counts_landers_and_created_at

GROUP BY
	YEARWEEK(session_created_at)

-- From the output we can observe that the bounce_rate has come down and It improved the business performance.
